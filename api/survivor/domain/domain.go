...
type Survivor struct {
	...
	Disorders         []uuid.UUID    `json:"disorders,omitempty"`
	FightingArt       *uuid.UUID     `json:"fightingArt,omitempty"`
	SecretFightingArt *uuid.UUID     `json:"secretFightingArt,omitempty"`
}
